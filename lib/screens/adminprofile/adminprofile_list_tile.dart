...
class AdminProfileListTile extends StatelessWidget {
  final int _index;
  const AdminProfileListTile(this._index);

  @override
  Widget build(BuildContext context) {
    return SelectorView<AdminProfileViewmodel, User>(
        ...
        builder: (context, vm, user, __) => Column(
              ...
              children: <Widget>[
                ...
                Text("Admin Profile", style: TextStyle(fontSize: 30.0)),
